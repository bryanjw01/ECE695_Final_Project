...
from variables import ENCODER_INPUT, DECODER_INPUT, device
import pdb
...
class Validate:
                ...
                if bayes:
                    ...
                    for _ in range(10):
                        if output == None:
                            ...
                            temp, attention = model.decoder(trg_tensor, enc_src, trg_mask, src_mask)
                            output = output + temp
                else:
                    output, attention = model.decoder(trg_tensor, enc_src, trg_mask, src_mask)
    ...
    def validate(self, model):
        ...
        for i, d in enumerate(self.data):
            ...
            translation, attention = self.translate_sentence(src, model, device, max_length, True)
